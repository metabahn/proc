...
test("fails when a composition calls an undefined proc", async () => {
  ...
  await expect(() => composition.call()).rejects.toThrowError("undefined proc `type.string.missing'; try one of: type.string, type.string.append, type.string.capitalize, type.string.characters, type.string.chomp, type.string.downcase, type.string.empty, type.string.equal, type.string.integer, type.string.length, type.string.prepend, type.string.reverse, type.string.swapcase, type.string.truncate, type.string.upcase");
});
